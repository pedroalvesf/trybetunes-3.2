    ...
    return (
        <div className="  ">
            ...
            ">
                ...
                <div>
                    <span className="footer-title">Comunity</span>
            ...
            <footer className="footer px-56 py-4 border-t bg-[#101010]/90  text-base-content border-base-300">
                ...
                ">
                    ...
                    <p>EoBera Industries Ltd. <br />Providing reliable songs since 2023</p>
                </div>
